package SmartEDI.Route.Common.Services.Web.Helper;

// -----( IS Java Code Template v1.2
// -----( CREATED: 2015-05-06 14:32:24 EDT
// -----( ON-HOST: testBox-PC
...

{
        ...
        throws ServiceException
	{
        ...
        {
            throw new ServiceException("TRNSERV.000018.000062" + t);
        }
        finally
        {
            if(cur != null)
        ...
        throws ServiceException
	{
		...
		String SQIdentityExternalID = ValuesEmulator.getString(ids, "SQIdentityExternalID");
		...
		//external ID
		ID extID = new ID();
		int i = Integer.parseInt(idTypes.get("SQIdentity").toString());
		//System.out.println("SQIdentity" + i);
		extID.setIDType(i); 
		extID.setExternalID(SQIdentityExternalID);
		profile.addID(extID);
