...

{
  ...
  static ssl _newInstance()
  {
    return new ssl();
  }

  static ssl _cast(Object o)
  {
    return (ssl) o;
  }
  ...
  public static final void extractCertificate(IData pipeline) throws ServiceException
  {
  ...
  public static final void extractChain(IData pipeline) throws ServiceException
  {
  ...
  public static final void importUserCertificate(IData pipeline) throws ServiceException
  {
    ...
    try
    {
      ...
      com.wm.app.b2b.server.CertificateMapEntry acertificatemapentry[] = com.wm.app.b2b.server.CertificateMapper.current().listMappings();
      if (acertificatemapentry != null && acertificatemapentry.length != 0)
      {
        for (int i = 0; i < acertificatemapentry.length; i++)
        {
          java.security.cert.X509Certificate aX509certificate = acertificatemapentry[i].getCertificate();
          if (serialNumber.equals(aX509certificate.getSerialNumber().toString()) && issuer.equals(aX509certificate.getIssuerDN().toString()))
          {
