...
// -----( CREATED: 2006-07-13 12:38:52 EDT
// -----( ON-HOST: ohcleapp4115.corpdev.ntl-city.net
...

{
  ...
  public static final void cacheLookup(IData pipeline) throws ServiceException
  {
    ...
    {
      readTable(lookupName, lookupTable);
      if (maxAge > 0)
      {
    ...
    {
      addDataToTable(lookupData, lookupTable);
  ...
  public static final void getTable(IData pipeline) throws ServiceException
  {
    ...
    if ((lookupTable == null || lookupTable.size() == 0) && dataRetrievalService != null)
    {
  ...
  public static final void lookupValue(IData pipeline) throws ServiceException
  {
    ...
    if (lookupTable == null && dataRetrievalService != null)
    {
      lookupTable = new LookupCacheTable(lookupKeyNames, dataRetrievalService);
      if (dataRetrievalService != null && dataRetrievalService.length() > 0)
      {
    ...
    if (lookupTable != null)
    {
      ...
      {
        IDataUtil.put(cursor, "lookupValue", getValueFromTable(lookupValueKeyName, lookupData));
      }
    }
    else
    {
  ...
  public synchronized static void readTable(String lookupName, LookupCacheTable lookupTable) throws ServiceException
  {
  ...
  private static void addDataToTable(IData[] lookupData, LookupCacheTable lookupTable) throws ServiceException
  {
    if (lookupData == null)
    {
      return;
