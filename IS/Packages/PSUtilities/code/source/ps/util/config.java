...
// -----( CREATED: 2007-03-28 12:39:28 EDT
...

{
  ...
  static IData loadConfiguration(String packageName, String configFilename, String documentTypeName) throws ServiceException
  {
    ...
    try
    {
      output = Service.doInvoke("ncFbmCommon.util.config", "readConfigFile", IDataFactory.create(new Object[][] { { "packageName", packageName }, { "configFilename", configFilename },
